          ...
          <div class="row" style="margin: 0px;padding: 0px;">
            <div class="col-lg-6" style="margin: 0px;padding: 0px;">
              <button class="btn btn-success btn-sm"type="button" name="button"
                      style="float: left"  onclick="displaySaleInfo()">sales report
              </button>
            ...
            <div class="col-lg-6" style="margin: 0px;padding: 0px;">
              <button class="btn btn-success btn-sm"type="button" name="button"
                       style="float: right"   onclick="hideSaleInfo()">general report
              </button>
            ...
            <form class="text-center"  id="input_form" role="form"  enctype="multipart/form-data">
                ...
                <fieldset style="margin: 0px;padding: 0px; margin-top: 30px" >
                  <hr>
                  <legend style="margin: 0px;padding: 0px; font-size: 14px">Date farrowed</legend>
               ...
               <fieldset style="margin: 0px;padding: 0px;  margin-top: 20px" id="report_date_sold">
                 <hr>

                 <legend style="margin: 0px;padding: 0px; font-size: 14px">Date sold</legend>
              ...
              <fieldset style="margin: 0px;padding: 0px; margin-top: 20px" id="report_ammount_sold">
                <hr>

                <legend style="margin: 0px;padding: 0px; font-size: 14px">Ammount sold</legend>
                <div class="form-row" style="margin: 0px;padding: 0px;"  >
                    <div class="col" style="margin: 0px;padding: 0px;">
                        <!-- First name -->
                        <div class="md-form" style="margin: 0px;padding: 0px;">
                ...
                <div class="form-row" style="margin: 0px;padding: 0px;"  >
                    <div class="col" style="margin: 0px;padding: 0px;" >
                        <!-- First name -->
                        <div class="md-form" style="margin: 0px;padding: 0px;">
                            <label for="">MAximum Ammount</label>
                        </div>
                    </div>
                    <div class="col" tyle="margin: 0px;padding: 0px;" >
                        <!-- Last name -->
               ...
               <fieldset style="margin: 0px;padding: 0px; margin-top: 20px">
                 ...
                 <legend style="margin: 0px;padding: 0px; font-size: 14px">Weight</legend>
                 <div class="form-row" style="margin: 0px;padding: 0px;"  >
                     <div class="col" style="margin: 0px;padding: 0px;">
                         <!-- First name -->
                         <div class="md-form" style="margin: 0px;padding: 0px;">
                     ...
                     <div class="col" style="margin: 0px;padding: 0px;">
                         <!-- Last name -->
                         <div class="md-form" style="margin: 0px;padding: 0px;  margin-top: 20px">
                           <input type="number" id="reports_min_weight"   style="margin: 0px;padding: 0px;" class="form-control">
                         </div>
                     </div>
                 </div>
                 ...
                 <div class="form-row" style="margin: 0px;padding: 0px;"  >
                     <div class="col" style="margin: 0px;padding: 0px;" >
                         <!-- First name -->
                         <div class="md-form" style="margin: 0px;padding: 0px;">
                             <label for="">MAximum weight</label>
                         </div>
                     </div>
                     <div class="col" tyle="margin: 0px;padding: 0px;" >
                         <!-- Last name -->
                         <div class="md-form" style="margin: 0px;padding: 0px; margin-top: 20px" >
                           <input type="number" id="reports_max_weight"   style="margin: 0px;padding: 0px;" class="form-control">
                         </div>
                     </div>
                 </div>
               </fieldset>
               ...
               <fieldset style="margin: 0px;padding: 0px; margin-top: 20px">
                 <hr>
                 <legend style="margin: 0px;padding: 0px; font-size: 14px">Sex</legend>

                 <div class="form-row" style="margin: 0px;padding: 0px;"  >
                     <div class="col" style="margin: 0px;padding: 0px;" >

                       <div class="md-form" style="margin: 0px;padding: 0px; margin-top: 20px" >
                         <input type="checkbox" id="reports_sex_male"   style="margin: 0px;padding: 0px;" class="form-control">Male
                       </div>
                     </div>
                     <div class="col" tyle="margin: 0px;padding: 0px;" >
                         <!-- Last name -->
                         <div class="md-form" style="margin: 0px;padding: 0px; margin-top: 20px" >
                           <input type="checkbox" id="reports_sex_female"   style="margin: 0px;padding: 0px;" class="form-control">Female
                         </div>
                     </div>
                 </div>
               </fieldset>
               ...
               <fieldset style="margin: 0px;padding: 0px; margin-top: 20px;">
                 <hr>
                 <legend style="margin: 0px;padding: 0px; font-size: 14px">Breeeds</legend>
